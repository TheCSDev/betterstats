...
/**
 * {@link StatsTab} that displays "General" statistics.
 */
public final class StatsTabGeneral extends BetterStatsTab<CustomStat>
{
	// ================================================== ==================================================
	//                                    StatsTabGeneral IMPLEMENTATION
	// ================================================== ==================================================
	public static final StatsTabGeneral INSTANCE = new StatsTabGeneral();
	// ==================================================
	private StatsTabGeneral() {}
	// ==================================================
	...
	public final @Override void initStats(StatsTab.StatsInitContext context)
	{
		...
		getStatsGrouper(context.getFilters())
				.apply(pagedStats).forEach((gName, gStats) ->
						StatsTabUtils.initGeneralStats(
	 ...
	 */
	private final void postProcessWidget(@NotNull StatsTab.StatsInitContext context, @NotNull TCustomStatWidget widget)
	{
		...
		if(stat.isDistance()) {
			...
			widget.formatterOverrideProperty().set(distanceUnit.getFormatter(), StatsTabGeneral.class);
		}
		else if(stat.isTime()) {
			final var timeUnit = context.getFilters().getProperty(TimeUnit.class, TimeUnit.FID, TimeUnit.VANILLA);
			widget.formatterOverrideProperty().set(timeUnit.getFormatter(), StatsTabGeneral.class);
		}
	}
	// --------------------------------------------------
	...
	public static enum SortBy implements TDropdownWidget.Entry
	{
		 ...
		 * @see BetterStatsTab#getStatsSorter(Filters)
		 */
	...
	public static enum DistanceUnit implements TDropdownWidget.Entry
	{
		...
		public static final void initFilter(@NotNull StatsTab.FiltersInitContext context) throws NullPointerException
		{
			...
			dropdown.tooltipProperty().set(__ -> TTooltip.of(BSSLang.gui_statstab_filter_distanceUnit()), DistanceUnit.class);
			panel.add(dropdown);
	...
	public static enum TimeUnit implements TDropdownWidget.Entry
	{
		...
		public static final void initFilter(@NotNull StatsTab.FiltersInitContext context) throws NullPointerException
		{
			...
			dropdown.tooltipProperty().set(__ -> TTooltip.of(BSSLang.gui_statstab_filter_timeUnit()), TimeUnit.class);
			panel.add(dropdown);
